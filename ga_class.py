...
class llamathwiz:
    ...
    def get_random_test_object(self, dataset):
...
#         return generated_text
    ...
    def iteration_first(self, num_instructions=10):
        ...
        mutation_prompt = self.get_random_mutation_txt("./Prompt-Engineering-OpenDI/mutation_prompts.txt")
        for _ in range(num_instructions):
            question, database_answer = self.get_random_test_object(self.dataset)  # Fetch a random question from your dataset
